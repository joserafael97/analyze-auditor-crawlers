...
Com base no objetivo de avaliar o algoritmo Epsilon-greedy em relação a algortimos clássicos no que se refere a busca por novas páginas no processo de crawling, foram criados intervalos de confiança para a mediana de nós acessados entre os critérios fiscais para os algoritmos Bfs que obteve melhor resultado e o Epsilon-greedy.  
