...
Para avaliar a perfomance do Crawler focado com o uso dos diferentes algoritmos, foi empregado o uso do número de nós acessados nas avaliações. Esta métrica foi escolhida em virtude de sua manutenção em relação a possíveis instabilidades ocorridas durante as avaliações, pois independentemente da avaliação o número de nós para finalizar uma avaliação devem possuir um valor similar na avaliação de um mesmo portal. Neste cenário, a Figura y mostra a distribuição a mediana do número de nós acessados nas avaliações entre os três algoritmos testados.
