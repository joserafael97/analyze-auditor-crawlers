...
precisao %>% 
    ...
    summarize(true_positive = sum(tp == TRUE), total_itens = n()) %>%
    ggplot() + 
    geom_bar(aes(x=criterio, y=true_positive), fill="#DD8888",stat="identity") + 
    geom_smooth(y=total_itens, color = "blue",size = 0.8)
```
